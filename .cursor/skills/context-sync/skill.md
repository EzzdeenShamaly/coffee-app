...
- State management: flutter_bloc, event-driven Bloc everywhere (no Cubit), sealed Equatable events and state variants
- Routing: go_router, ShellRoute in use for bottom-nav
- Models: freezed + json_serializable
- HTTP client: dio
- Secure storage: flutter_secure_storage (used for auth tokens)
- Testing: bloc_test + mocktail; widget tests provide their bloc explicitly; no integration_test yet
```
