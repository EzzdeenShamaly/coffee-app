...
description: "Backfills widget, bloc, or repository tests onto existing Flutter code using bloc_test state-sequence assertions, provided blocs over faked repositories, MockBloc for exact render states, and mocktail fakes, covering in-progress/failure/empty states and asserting behavior rather than implementation. Use when asked to add test coverage to existing code. Invoked as /flutter-test-gen."
---
