...
description: "Read-only scan for common Flutter jank causes: missing const, whole-screen BlocBuilder where BlocSelector/buildWhen would narrow rebuilds, ListView/Column used instead of .builder for long lists, unmanaged image caching, and expensive work inside build(). Use when asked about performance, jank, or rebuild issues. Invoked as /flutter-performance-audit."
---
