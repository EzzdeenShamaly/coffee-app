...
description: "Generates a full Flutter screen in one pass: the screen widget, its backing flutter_bloc Bloc, and the go_router route registration, handling every sealed state variant (in-progress/failure/empty/populated) explicitly. Use when asked to build a new screen or page. Invoked as /flutter-screen-gen."
---
